...
(function() {
    ...
    const OCTICONS = {
        ...
        tag: '<svg class="octicon octicon-tag color-fg-attention" viewBox="0 0 16 16" width="14" height="14" fill="currentColor"><path d="M1 2.5A1.5 1.5 0 0 1 2.5 1h4.879a1.5 1.5 0 0 1 1.06.44l6.294 6.293a1.5 1.5 0 0 1 0 2.122l-4.878 4.878a1.5 1.5 0 0 1-2.122 0L1.44 8.44A1.5 1.5 0 0 1 1 7.38V2.5Zm1.5 0a.25.25 0 0 0-.25.25V7.38a.25.25 0 0 0 .073.177l6.294 6.293a.25.25 0 0 0 .354 0l4.878-4.878a.25.25 0 0 0 0-.354L7.573 2.324A.25.25 0 0 0 7.38 2.25H2.5ZM5 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>',
    ...
    function renderListUI() {
        ...
        backportData.forEach(pr => {
            ...
            if (pr.skipStatusCheck) {
                ...
                else if (pr.ciStatus === 'review_required') iconHtml = OCTICONS.shield;
                else if (pr.ciStatus === 'label_required') iconHtml = OCTICONS.tag;
